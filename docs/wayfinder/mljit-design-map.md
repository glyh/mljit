...
- Frontend parser stack choice is still pending research and should be decided in [Choose the Generated Frontend Stack](tickets/choose-generated-frontend-stack.md).
